...
- CompTIA Network+ — subnetting, routing protocols, network architecture
- Linux networking — CLI tools, Bash scripting for network automation
- Cisco Packet Tracer — building and simulating network topologies
...
| 🔜 Subnetting Calculator | Python tool for IP/subnet breakdowns | Python 
| 🔜 Network+ Study Notes | Organized markdown notes covering all Network+ domains | Markdown 
